...
app.get('/', (req, res) => {
    ...
    let url = 'https://api.themoviedb.org/3/movie/293660?api_key=03f71e864ceef92eda9743005dd1ab52';
    axios.get(url)
    .then(response => {
...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=03f71e864ceef92eda9743005dd1ab52&query=${userMovieTitle}`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=03f71e864ceef92eda9743005dd1ab52&language=en-US';
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=72042c7a`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
